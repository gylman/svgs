  ...
  return (
    <svg width='1100' height='406' viewBox='0 0 1100 406' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <g filter='url(#filter6_d_106_4195)'>
        ...
        <rect x='198.5' y='44.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter7_d_106_4195)'>
        ...
        <rect x='511.5' y='44.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter8_d_106_4195)'>
        ...
        <rect x='511.5' y='120.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter9_d_106_4195)'>
        ...
        <rect x='511.5' y='255.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter10_d_106_4195)'>
        ...
        <rect x='511.5' y='331.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter11_d_106_4195)'>
        ...
        <rect x='198.5' y='120.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter12_d_106_4195)'>
        ...
        <rect x='198.5' y='331.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter13_d_106_4195)'>
        ...
        <rect x='198.5' y='255.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
      ...
      <g filter='url(#filter14_d_106_4195)'>
        ...
        <rect x='355.5' y='187.5' width='117' height='31' rx='3.5' stroke={highlight} shapeRendering='crispEdges' />
        <text
          fill='#090A0F'
          xmlSpace='preserve'
          style={{ whiteSpace: 'pre' }}
